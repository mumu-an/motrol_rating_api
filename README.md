...
9. **接口4：**:
    ...
    接口4返回结果：
    {
        "msg": "已删除润子喵_100_1780390096501063493 任务"
    }
    删除指定任务，防止过多任务占用资源

10. **可能用到的linux命令**:
    更新apt:sudo apt update
    检查浏览器是否输出版本号有输出才能使用:./fingerprint_browser/chrome --version
    安装服务器chrome gui框架:sudo apt install -y libatk-bridge2.0-0 libatk1.0-0 libgtk-3-0 libnss3 libxss1 libasound2 libgbm1 libx11-xcb1 libxcomposite1 libxdamage1 libxrandr2 libpangocairo-1.0-0 libpango-1.0-0 libcairo2
    安装linux字体:apt install -y fonts-noto-cjk